                     ...
                     <div className="grid grid-cols-1 gap-4">
                        {currentQuestion.options.map((opt, i) => (
                           <button 
                              ...
                              className={`flex items-center gap-5 p-6 rounded-[1.5rem] border-2 text-left transition-all transform active:scale-[0.98] ${
                           ...
                           >
                              <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black text-sm transition-colors ${
                                 answers[currentQuestion.id] === i ? 'bg-indigo-600 text-white' : 'bg-white dark:bg-slate-700 text-gray-500 border border-gray-200 dark:border-slate-600'
                              }`}>
